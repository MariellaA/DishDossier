...
class RecipeAPIHandler():
    def __init__(self):
        ...
        self.sendinblue_config = sib_api_v3_sdk.Configuration()
        self.sendinblue_config.api_key['api-key'] = self.load_email_api_key()
    ...
    @staticmethod
    def load_email_api_key():
        with open('email_api_key.txt', 'r') as file:
            key = file.read()
        return key
